...
<div class="checkout">
	<div class="container">
		...
		<div class="checkout-left">
				...
				<div class="checkout-right-basket animated wow slideInRight" data-wow-delay=".5s">
					<a href="#"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Hủy giỏ hàng</a>
				</div>

        <div class="checkout-right-basket animated wow slideInRight" data-wow-delay=".5s">
          <a href="#"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Thanh toán</a>
        </div>
